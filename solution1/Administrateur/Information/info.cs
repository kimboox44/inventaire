    ...
    public partial class info : Form
    {
        ...
        private void modification(string reg, string ident, string fisc, string logo)
        {
            ...
            if (fisc != "")
            {
                ...
                string req = "update information set num_fiscal = " + reg;
        ...
        private void fisc_Click(object sender, EventArgs e)
        {
        ...
        private void textBox_logo_TextChanged(object sender, EventArgs e)
        {
        ...
        private void textBox_ident_TextChanged(object sender, EventArgs e)
        {

        }

        private void textBox_fisc_TextChanged(object sender, EventArgs e)
        {
